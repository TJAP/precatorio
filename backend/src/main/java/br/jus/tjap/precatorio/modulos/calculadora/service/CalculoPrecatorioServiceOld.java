...
@Service
public class CalculoPrecatorioServiceOld {
    ...
    public CalculoPrecatorioServiceOld(
    ...
    public CalculoAtualizacaoDTO calcularPagamento(CalculoAtualizacaoDTO atualizacao, boolean temHC){
    ...
    public CalculoAtualizacaoDTO calcularAtualizacao(CalculoRequest req) {
        validateRequest(req);
        var resultado = new CalculoAtualizacaoDTO();
    ...
    public CalculoResponse calcularAntigo(CalculoRequest req) {
        try {
            ...
            BigDecimal totalComJurosTributavelNoPeriodo = req.getDataInicioRRA() == null ?
                    ZERO :
                    percJurosFinal.multiply(principalTribAtual).divide(CEM, 10, RoundingMode.HALF_UP);

            BigDecimal totalComJurosNaoTributavelNoPeriodo = req.getDataInicioRRA() == null ?
